 ...
 */
function UpcomingCasesButton({ showUpcomingCases, upcomingCasesCount, onClick }) {
  return (
    <button
      onClick={onClick}
...
export default function Header({
  ...
  const canSeeUpcomingCases = 
    currentView === VIEW_MODES.USER && 
    (currentUser?.userType === USER_TYPES.SURGEON || currentUser?.userType === USER_TYPES.TRAINEE);
